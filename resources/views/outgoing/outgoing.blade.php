...
<div x-data="{ 
    ...
    submitUpload(event) {
        ...
        if (customContainer && customContainer.style.display !== 'none' && customInput.value.trim() !== '') {
            hiddenInput.value = customInput.value.trim();
        } else if (customContainer && customContainer.style.display !== 'none' && customInput.value.trim() === '') {
